...
if not is_win32:
	...
	gridpy_exe = r"F:\libsvm-3.18\tools\grid.py -log2c -2,9,2 -log2g 1,-11,-2"
	svmtrain_exe = r"F:\libsvm-3.18\windows\svmtrain.exe"
	svmpredict_exe = r"F:\libsvm-3.18\windows\svmpredict.exe"
